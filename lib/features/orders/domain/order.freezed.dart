...
mixin _$Order {
 ...
 String? get notes;// Joined from shops — populated by repo queries that include a shop join
@JsonKey(name: 'shop_name') String? get shopName;@JsonKey(name: 'shop_number') String? get shopNumber;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderNumber,distributorId,salesmanId,shopId,areaId,subtotal,gstTotal,grandTotal,orderDate,createdAt,notes,shopName,shopNumber);

@override
String toString() {
  return 'Order(id: $id, orderNumber: $orderNumber, distributorId: $distributorId, salesmanId: $salesmanId, shopId: $shopId, areaId: $areaId, subtotal: $subtotal, gstTotal: $gstTotal, grandTotal: $grandTotal, orderDate: $orderDate, createdAt: $createdAt, notes: $notes, shopName: $shopName, shopNumber: $shopNumber)';
}
...
switch (_that) {
case _Order() when $default != null:
return $default(_that.id,_that.orderNumber,_that.distributorId,_that.salesmanId,_that.shopId,_that.areaId,_that.subtotal,_that.gstTotal,_that.grandTotal,_that.orderDate,_that.createdAt,_that.notes,_that.shopName,_that.shopNumber);case _:
  return orElse();
