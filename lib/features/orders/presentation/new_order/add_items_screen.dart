...
class AddItemsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddItemsScreen> createState() =>
      _AddItemsScreenState();
}
            ...
            child: Column(
              children: [
                ...
                AppButton(
                  ...
                  onPressed:
                      draft.items.isNotEmpty && !hasInvalidRate
...
class _ItemRowState extends State<_ItemRow> {
  ...
  void didUpdateWidget(_ItemRow oldWidget) {
    ...
    if (!_editingRate &&
      ...
      _rateCtrl.text =
          widget.item.sellingRate.toStringAsFixed(0);
    }
  }
